  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios({
        url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyAEc7bLZau7YbiKycCoKs835CH7t-i7FSU`,
        method: "post",
        data: {
    ...
    <div className="fixed inset-0 bg-gradient-to-r from-white  to-purple-500">
      <div className="h-full max-w-4xl mx-auto flex flex-col p-3 ">
        ...
        <header className="text-center py-4">
          <a href="https://github.com/RohithReddy-1402?tab=repositories" 
             target="_blank" 
        ...
        >
          {chatHistory.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-6 bg-gradient-to-r from-purple-500 to-white">
              <div className="bg-blue-50 rounded-xl p-8 max-w-2xl from-purple-500 to-white">
        ...
        <form onSubmit={generateAnswer}  className="bg-white rounded-lg shadow-lg p-4">
          <div className="flex gap-2">
            <textarea
              required
              className="flex-1 border border-gray-300 rounded p-3 focus:border-blue-400 focus:ring-2 focus:ring-blue-800 resize-none"
              value={question}
